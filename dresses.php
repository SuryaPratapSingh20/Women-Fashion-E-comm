...
$sql = "SELECT id,image1,image2,Title,catogary,Discounted_Price,Original_Price FROM Product where catogary='Dresses' ORDER by id DESC";    
	...
	<body>
		...
		<div class="header">
			<div class="container">
				...
				<div class="w3l_logo">
					<h1><a href="index.php">Women's Fashion<span>For Fashion
								Lovers</span></a></h1>
				</div>
				<div class="search">
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav">
							...
							<!-- Mega Menu -->
							<li class="dropdown">
								<a href="#" class="dropdown-toggle act" data-toggle="dropdown">Products
									<b class="caret"></b></a>
										...
										<div class="panel-heading" role="tab" id="headingTwo">
											<h4 class="panel-title asd">
												<a class="pa_italic collapsed" role="button" data-toggle="collapse"
													...
													<span class="glyphicon glyphicon-plus" aria-hidden="true"></span><i
														class="glyphicon glyphicon-minus" aria-hidden="true"></i>Foot Wear
												</a>
											</h4>
										</div>
												...
												<div class='col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_dresses'>
													<div class='agile_ecommerce_tab_left dresses_grid'>																						
														<div class='hs-wrapper hs-wrapper2'>
															...
															<img src='images/$image2' alt=' ' class='img-responsive' />
															<img src='images/$image2' alt=' ' class='img-responsive' />
															<img src='images/$image2' alt=' ' class='img-responsive' />
															<img src='images/$image2' alt=' ' class='img-responsive' />
															<img src='images/$image2' alt=' ' class='img-responsive' />
														...
														<div class='simpleCart_shelfItem'>
															<p><span>$Discounted_Price</span> <i class='item_price'>$Original_Price</i></p>
									...
									<section>
										<div class="modal-body">
											...
											<div class="col-md-7 modal_body_right">
												...
												<p>Opt for a high-quality long skirt in a flattering silhouette,
													such as an A-line or maxi style. Choose a fabric that drapes
													beautifully, like chiffon, silk, or lightweight cotton, for an
													elegant and feminine look. </p>
												<div class="rating">
