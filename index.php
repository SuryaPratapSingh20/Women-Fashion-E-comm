...
<html>
	<head>
		<title>Women's Fashion Online Shopping Website</title>
		<!-- for-mobile-apps -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<body>
								...
								<div class="sap_tabs">
									<div id="horizontalTab"
										...
										<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
											<div class="facts">
												<div class="register">
													<form action="Login\loginconnection.php" method="post">
										...
										<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
											<div class="facts">
												<div class="register">
													<form action="Login/SignUpconnection.php" method="post">
		...
		<!-- Login popup disbale based on User Name -->
		<?php
								 
							if(isset($_SESSION['ActiveUserName']))
							  {
							  	//echo "<li class='js_nav-item nav-item'><a href='' class='nav-item-child nav-item-hover'>Hi :".$_SESSION['uname']."</a></li>";
				...
				<div class="w3l_login">
					<a href="#" data-toggle="modal" data-target="#myModal88"><span
							...
							<?php
									 ...
									 if(isset($_SESSION['ActiveUserName']))
									   {
										   echo "<p>Hi :".$_SESSION['ActiveUserName']."</p>";	
									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<h6>Clothing</h6>
												<li><a href="dresses.php">Dresses<span>New</span></a></li>
		...
		<div class="banner-bottom">
			<div class="container">
				<div class="col-md-5 wthree_banner_bottom_left">
					...
					<!-- pop-up-box -->
					<link href="css/popuo-box.css" rel="stylesheet" type="text/css" property
						media="all" />
					...
					<div class="bs-example bs-example-tabs" role="tabpanel"
						...
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							<li role="presentation" class="active"><a href="#home" id="home-tab"
									role="tab" data-toggle="tab" aria-controls="home">T-shirts</a></li>
							<li role="presentation"><a href="#skirts" role="tab" id="skirts-tab"
									data-toggle="tab" aria-controls="skirts">Skirts</a></li>
							<li role="presentation"><a href="#watches" role="tab" id="watches-tab"
									data-toggle="tab" aria-controls="watches">Watches</a></li>
							<li role="presentation"><a href="#sandals" role="tab" id="sandals-tab"
									data-toggle="tab" aria-controls="sandals">Sandals</a></li>
							<li role="presentation"><a href="#jewellery" role="tab"
									id="jewellery-tab" data-toggle="tab"
									aria-controls="jewellery">Jewellery</a></li>
						</ul>
								...
								<article style="position: absolute; width: 100%; opacity: 0;">
									<div class="banner-wrap">
										<div class="w3agile_special_deals_grid_left_grid1">
											...
											<p>A fashion designer is an individual who creates original clothing,
												accessories, and footwear designs. They are responsible for
												conceptualizing, designing, and producing garments that reflect
												current fashion trends, cultural influences, and personal style.</p>
											<h4>Laura</h4>
										</div>
									</div>
								</article>
								<article style="position: absolute; width: 100%; opacity: 0;">
									<div class="banner-wrap">
										<div class="w3agile_special_deals_grid_left_grid1">
											...
											<p>Fashion designers need to have a solid understanding of garment
												construction techniques, fabric properties, and sewing methods. They
												work closely with pattern-makers, seamstresses, and manufacturers to
												ensure that their designs are executed correctly</p>
											<h4>Michael</h4>
										</div>
									</div>
								</article>
								<article style="position: absolute; width: 100%; opacity: 0;">
									<div class="banner-wrap">
										<div class="w3agile_special_deals_grid_left_grid1">
											...
											<p>Fashion designers stay up-to-date with the latest fashion trends
												and developments in the industry. They attend fashion shows,
												research emerging designers, and analyze market trends to inform
